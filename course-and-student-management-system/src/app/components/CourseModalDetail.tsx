...
export default function CourseModalDetail({ openModalDetailView, onChange, setOpenModalDetailView, viewCourseModal }: ChildProps) {
  ...
  return (
    <Transition.Root show={openModalDetailView} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={setOpenModalDetailView}>
                ...
                <Dialog.Panel className="pointer-events-auto relative w-screen max-w-md">
                  ...
                  >
                    <div className="absolute left-0 top-0 -ml-8 flex pr-2 pt-4 sm:-ml-10 sm:pr-4">
                      <button type="button" className="rounded-md text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white" onClick={onChange}>
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                    <div className="px-4 sm:px-6">
                      <Dialog.Title className="text-base font-semibold leading-6 text-gray-900">Detalle del curso</Dialog.Title>
                    </div>
