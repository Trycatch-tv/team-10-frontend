...
const Users: React.FC<Props> = () => {
  ...
  return (
    <div className="p-4 bg-gray-200">
      ...
      <UserModalDelete openModalEditView={openModalDeleteView} onChange={handleChangeModalDeleteView} setOpenModalEditView={setOpenModalDeleteView} viewCourseModal={user.id} />
    </div>
  );
};
